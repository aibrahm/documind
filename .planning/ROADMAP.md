...
| 04 | **Project sidebar and workspace UI** | 🚧 in progress (2/4 plans landed) | 04-01 ✅ foundation. 04-02 ✅ ProjectSidebar + CreateProjectDialog + server actions, chat-sidebar deleted. 04-03 next: workspace shell + chat-first Overview tab. 04-04: remaining 4 tabs. |
