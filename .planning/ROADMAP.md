...
| 03.5 | **Tier 1 analytical tools** | 🚧 in progress (1/2 plans landed) | 03.5-01 ✅ — `financial_model` (NPV/IRR/payback/sensitivity, zero-dep pure JS) + `fetch_url` (regex HTML stripping). Verified end-to-end via deep-mode chat: NPV math exact, real Wikipedia page fetched verbatim. 03.5-02 next to author: `extract_key_terms` + `compare_deals` (depend on Phase 03 schema). |
