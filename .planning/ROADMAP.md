...
| 04 | **Project sidebar and workspace UI** | 🚧 in progress (3/4 plans landed) | 04-01 ✅ foundation. 04-02 ✅ ProjectSidebar + CreateProjectDialog + server actions. 04-03 ✅ workspace page at /projects/[slug] with chat-first Overview tab + backend project_id tagging on conversations. 04-04 next: remaining 4 tabs. |
